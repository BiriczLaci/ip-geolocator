 ...
 * implementation uses  <a href="http://ip-api.com">IP-API</a> service. The
...
public interface GeoLocator {
    ...
    /**
     * Return geolocation information about IP address or host name specified.
     *
    ...
    /**
     * Creates and returns on object that implements the interface.
     *
